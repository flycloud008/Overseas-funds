	...
	export default {
		...
		methods: {
			async load(){
				...
				if(this.moneyType ==1 ){
					this.money = this.vuex_userInfo.member.balance;
				}else if(this.moneyType ==2 ){
					this.money = this.vuex_userInfo.member.score;
				}else if(this.moneyType ==10 ){
					this.money = this.vuex_userInfo.member.jindou;
				}
				else if(this.moneyType >=3 ){
					this.money = this.vuex_userInfo.member['money'+this.moneyType];
				}
				
				
				this.loadPage("/user/getUserAccountChange",{moneyType:this.moneyType,changeType:this.changeType});
