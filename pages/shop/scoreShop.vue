	...
	<view class="container">
		...
		<view class="integrals-section">
			<view class="integrals">
				...
				<view class="value">{{vuex_userInfo.member.score}}</view>
			</view>
			<view class="menu">
				<view class="item"  @click="navTo('/pages/user/accountList',{title:'积分',moneyType:2,changeType:JSON.stringify([])})">积分明细</view>
...
.integrals-section {
	position: relative;
	margin-top: -100rpx;
	background: url('@/static/me_img_banner_mall.png') no-repeat;
